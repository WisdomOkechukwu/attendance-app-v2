                        ...
                        <div class="d-flex align-items-end row">
                            <div class="col-sm-7">
                                <div class="card-body">
                                    ...
                                    <p class="mb-4">You have done <span class="fw-medium">72%</span>
                                        more sales today. Check your new badge in your profile.</p>
                                        ...
                                        <div class="d-flex">
                                            <a href="javascript:void(0)" class="d-flex align-items-center me-3">
                                                <img src="{{ asset('assets/img/icons/misc/pdf.png') }}"
                                                    alt="PDF image" width="23" class="me-2">
                            ...
                            <ul class="nav nav-pills" role="tablist">
                                <li class="nav-item">
                                    <button type="button" class="nav-link active" role="tab"
                                        ...
                                        aria-controls="navs-pills-browser" aria-selected="true">Browser</button>
                                </li>
                                <li class="nav-item">
                                    ...
                                    <table class="table table-borderless text-nowrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/img/icons/brands/edge.png') }}"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/img/icons/brands/brave.png') }}"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/img/icons/brands/vivaldi.png') }}"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/img/icons/brands/uc.png') }}"
                                    ...
                                    <table class="table table-borderless">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/img/icons/brands/linux.png') }}"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/img/icons/brands/fedora.png') }}"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/img/icons/brands/vivaldi-os.png') }}"
                                                            alt="Vivaldi" height="24" class="me-2">
                                                        <span>Vivaldi</span>
                                                    </div>
                                                </td>
